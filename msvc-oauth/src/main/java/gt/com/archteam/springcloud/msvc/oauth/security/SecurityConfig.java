package gt.com.archteam.springcloud.msvc.oauth.security;
...
public class SecurityConfig {
	...
	RegisteredClientRepository registeredClientRepository() {
		RegisteredClient oidcClient = RegisteredClient.withId(UUID.randomUUID().toString())
				...
				.tokenSettings(TokenSettings.builder().accessTokenTimeToLive(Duration.ofHours(3))
	...
	/**
	 * Metodo usado para editar la data de un token.
	 * 
	 * @return
	 */
	@Bean
